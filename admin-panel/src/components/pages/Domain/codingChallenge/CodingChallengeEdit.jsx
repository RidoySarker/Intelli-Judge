...
const CodingChallengeAdd = () => {
    ...
    const codingChallengeForm = useFormik({
        ...
        onSubmit: (values, {resetForm}) => {
            http.put(`/coding-challenge/${id}`, values).then(() => {
                toast.success("Coding Challenge Update Successfully");
                // console.log(CKEditor,'content')
                // CKEditor.instances['content'].setData('');
                resetForm({values: ''});
                window.location.assign('/coding-challenge-list');
            })
                .catch(({error}) => {
                    console.log(error)
                });
    ...
    const fetchEditDetails = async () => {
        try {
            const {data:data} = await http.get(`/coding-challenge/${id}`);
            console.log(data)
            codingChallengeForm.setValues(data.data);
        } catch (error) {
            console.log(error)
        }
    }
                            ...
                            <form className="row g-3 needs-validation" noValidate
                                ...
                                <div className="col-md-12">
                                    ...
                                    <input type="text"
                                           ...
                                           value={codingChallengeForm.values.title}
                                    />
                                ...
                                <div className="col-md-12">
                                    ...
                                    <select
                                        ...
                                        onChange={codingChallengeForm.handleChange}
                                        onBlur={codingChallengeForm.handleBlur}
                                        value={codingChallengeForm.values.question_type}
                                    >
                                ...
                                <div className="col-md-12">
                                    ...
                                    <select
                                        ...
                                        onChange={codingChallengeForm.handleChange}
                                        onBlur={codingChallengeForm.handleBlur}
                                        value={codingChallengeForm.values.level}
                                    >
                                        <option value="">Select</option>
                                ...
                                <div className="col-md-12">
                                    ...
                                    <CKEditor
                                        ...
                                        data={codingChallengeForm.values.problem_statement}
