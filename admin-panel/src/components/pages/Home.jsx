                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="row d-flex justify-content-center">
                                        <div className="col-9">
                                            <p className="text-dark mb-0 fw-semibold">Total Users</p>
                        ...
                        <div className="col-md-3 col-lg-3">
                            <div className="card">
                                <div className="card-body">
                                    <div className="row d-flex justify-content-center">
                                        <div className="col-9">
                                            <p className="text-dark mb-0 fw-semibold">Total Active Users</p>
                                            <h3 className="my-1 font-20 fw-bold">0</h3>
                                        </div>
                                        {/*end col*/}
                                        <div className="col-3 align-self-center">
                        ...
                        <div className="col-md-3 col-lg-3">
                            <div className="card">
                                <div className="card-body">
                                    <div className="row d-flex justify-content-center">
                                        <div className="col-9">
                                            <p className="text-dark mb-0 fw-semibold">Total General Users</p>
                                            <h3 className="my-1 font-20 fw-bold">0</h3>
                                        </div>
                                        {/*end col*/}
                                        <div className="col-3 align-self-center">
                        ...
                        <div className="col-md-3 col-lg-3">
                            <div className="card">
                                <div className="card-body">
                                    <div className="row d-flex justify-content-center">
                                        <div className="col-9">
                                            <p className="text-dark mb-0 fw-semibold">Total Referral Users</p>
                                            <h3 className="my-1 font-20 fw-bold">0</h3>
                                        </div>
                                        {/*end col*/}
                                        <div className="col-3 align-self-center">
