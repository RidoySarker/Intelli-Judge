/*
  ...
  - Added the required column `user_id` to the `study_plan` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `study_plan` ADD COLUMN `user_id` INTEGER NOT NULL;
