...
-- AddForeignKey
ALTER TABLE `contest_submissions` ADD CONSTRAINT `contest_submissions_question_id_fkey` FOREIGN KEY (`question_id`) REFERENCES `coding_challenges`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `contest_submissions` ADD CONSTRAINT `contest_submissions_contest_id_fkey` FOREIGN KEY (`contest_id`) REFERENCES `contest`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
