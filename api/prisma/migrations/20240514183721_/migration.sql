/*
  ...
  - You are about to alter the column `is_approved` on the `coding_challenges` table. The data in that column could be lost. The data in that column will be cast from `Text` to `Int`.
...
-- AlterTable
ALTER TABLE `coding_challenges` MODIFY `is_approved` INTEGER NOT NULL DEFAULT 0,
