/*
  ...
  - Added the required column `courseImage` to the `course_categories` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `course_categories` ADD COLUMN `courseImage` VARCHAR(255) NOT NULL;
